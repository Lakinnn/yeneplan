...
function Router() {
  return <Switch><Route path="/"><DashboardLayout><Dashboard /></DashboardLayout></Route><Route path="/today"><DashboardLayout><Today /></DashboardLayout></Route><Route path="/visions"><DashboardLayout><VisionBoard /></DashboardLayout></Route><Route path="/month"><DashboardLayout><Month /></DashboardLayout></Route><Route path="/coach"><DashboardLayout><Coach /></DashboardLayout></Route><Route path="/community"><DashboardLayout><Community /></DashboardLayout></Route><Route path="/settings"><DashboardLayout><Settings /></DashboardLayout></Route><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>;
}
